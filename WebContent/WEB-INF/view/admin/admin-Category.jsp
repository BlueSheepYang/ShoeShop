        ...
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          ...
          <c:forEach var="Category" items="${allCategory}">
			<tr class="CustomerStyle">
				...
				<td width="20%"><span>${Category.categoryId}</span></td>
				<td width="20%"><span>${Category.categoryName}</span></td>
				<td>
				<c:url var="categoryDelete" value="/admin/categoryDelete">
				<c:param name="categoryId" value="${Category.categoryId }" />
				</c:url>
	            <a href="${categoryDelete }" onclick="if (!(confirm('你确定要删除这项分类吗?'))) return false">删除此分类</a>          
				</td>
			</tr>
		</c:forEach>   
		<tr class="CustomerStyle">
				<td width="20%"></td>
				<td width="20%"><input type="text" id="newCategory"/></td>
				<td>
				<c:url var="categoryAdd" value="/admin/categoryAdd"></c:url>
	            <a href="javascript:sub();" onclick="if (!(confirm('你确定要添加这项分类吗?'))) return false">添加此分类</a>          
				</td>
		</tr>
	</tbody>
	</table>
	<c:url var="addCategory" value="/admin/addCategory"></c:url>
    <h2><a href="${ addCategory }">增加分类</a></h2>
	</form>
