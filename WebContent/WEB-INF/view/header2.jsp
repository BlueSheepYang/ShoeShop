...
<body>
	<div class="header-bottom">
		<div class="container">
			<div class="top-nav">
			<c:url var="Hello" value="/"></c:url>
			<c:url var="Error" value="/Error"></c:url>
				<ul class="memenu skyblue"><li class="active"><a href="${ Hello }">主页</a></li>
						...
						<div class="mepanel">
							<div class="row">
								<div class="col1 me-one">
									<h4>适用人群</h4>
									<ul>
										<li><a href="${Error }">儿童</a></li>
										<li><a href="${Error }">青年</a></li>
										<li><a href="${Error }">中年</a></li>
										<li><a href="${Error }">老年</a></li>
									</ul>
								</div>
								<div class="col1 me-one">
									<h4>鞋子类型</h4>
						...
						<div class="mepanel">
							<div class="row">
								...
								<div class="col1 me-one">
									...
									<ul>
										<c:forEach var="category" items="${categories }">
											<li><a href="${Error }">${category.categoryName }</a></li>
										</c:forEach>
									</ul>	
								</div>
							</div>
						...
						<div class="mepanel">
							<div class="row">
								<div class="col1 me-one">
									<h4>季节</h4>
									<ul>
										<li><a href="${Error }">春季</a></li>
										<li><a href="${Error }">夏季</a></li>
										<li><a href="${Error }">秋季</a></li>
										<li><a href="${Error }">冬季</a></li>
									</ul>
								</div>
							</div>
						</div>
