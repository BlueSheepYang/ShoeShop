        ...
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          <thead>
            <tr class="am-success">
              ...
              <th class="table-title">商品种类</th>
              <th width="163px" class="table-set">商品数量</th>
            </tr>
          </thead>
          <tbody>
          <c:forEach var="commodity" items="${Commodity}">
			<tr class="CustomerStyle">
				<td width="20%"><span>${commodity.commodityId}</span></td>
				<td width="20%"><span>${commodity.commodityName}</span></td>
				<td width="20%"><span>${commodity.commodityType }</span></td>
				<td><span>${commodity.commodityNumber}</span></td>
			</tr>
		</c:forEach>   
	</tbody>
	</table>
