...
public class Customer {
	...
	public Customer(String userTrueName, String userNickname, String userPassword, String userSex, String userPhone,
			String userAddress, String userIdentification, String userEmail) {
		this.userTrueName = userTrueName;
		this.userNickname = userNickname;
		this.userPassword = userPassword;
		this.userSex = userSex;
