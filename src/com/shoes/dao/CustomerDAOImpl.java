...
public class CustomerDAOImpl implements CustomerDAO {
	...
	public List<Customer> getCustomers() {
		...
		Query<Customer> theQuery = 
				currentSession.createQuery("from Customer order by usertruename", Customer.class);
	...
	public Customer getCustomer(String name) {
		...
		Query<Customer> theQuery = 
				currentSession.createQuery("from Customer where usernickname = " + "\'" + name + "\'" ,Customer.class);
				
		Customer theCustomer = theQuery.getResultList().get(0);
